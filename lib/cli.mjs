...
const COMMAND_EXAMPLES = {
  ...
  contact:      ['sizmo contact create --email a@b.co --name "Acme Co"', 'sizmo contact create --phone +14155551234 --tag VIP,lead --confirm'],
  field:        ['sizmo field create --name "Lead Source" --type TEXT', 'sizmo field create --name "Budget" --type MONETORY --model opportunity --confirm'],
  value:        ['sizmo value create --name "Booking Link" --value "https://cal.me/x" --confirm'],
